 ...
 * Size: 18 px
 * Bpp: 1
 * Opts: --bpp 1 --size 18 --no-compress --font JetBrainsMono-Light.ttf --symbols abcdefghijklmnopqrstuvwxyz.,-öäü+#´ß?ÄÖÜ<>|;:_{[]}\@€ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890^!"§$%&/()=?░❱◎↘◌◩«■» --format lvgl -o jetbrains_mono_light_10.c
 ******************************************************************************/

#include "lvgl.h"

#ifndef JETBRAINS_MONO_LIGHT_10
#define JETBRAINS_MONO_LIGHT_10 1
#endif

#if JETBRAINS_MONO_LIGHT_10
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t jetbrains_mono_light_10 = {
#else
lv_font_t jetbrains_mono_light_10 = {
#endif
...
#endif /*#if JETBRAINS_MONO_LIGHT_10*/
